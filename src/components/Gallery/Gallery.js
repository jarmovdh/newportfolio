    ...
    <div className="gallery-item-wrapper">
      ...
      <div className="gallery-item">
        <div className="gallery-item-info">
          <h1 className="galler-info-title">{title}</h1>
          <h6 className="galler-info-subtitle">{subtitle}</h6>
...
const Gallery = () => {
  ...
  return (
    <section className="gallery-wrapper gallery-wrap">
      <div className="gallery">
        <div className="gallery-counter">
          <span className="active-image">{activeImage}</span>
